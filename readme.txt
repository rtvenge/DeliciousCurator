...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=jonas%2enordstrom%40gmail%2ecom&lc=SE&item_name=Jonas%20Nordstrom%2c%20Windy%20Media&item_number=delicious%2dcurator&currency_code=EUR&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted
Tags: delicious, curating, bookmarks
...
But if you still want a way to create WordPress post based on one or more links that you shared from your RSS reader, you are in luck. Share the links to Delicious ("bookmark" them), tag them with something recognizable and use this plugin to generate the post.

The steps to take:

1. Install the plugin
2. Go to the settings page for the plugin and enter Delicious user name and what Delicious tag(s) to look for
3. Design the post template. Relax, it's short, easy and there's a default template you can use.
4. Share interesting stuff on Delicious
